...
document.getElementById("talle").value = decodeURIComponent(parts[2][1])
...
function modificar() {
    ...
    //https://crud23034.pythonanywhere.com/productos
    // Falta /
    ...
    fetch(url, options)
        .then(function () {
            ...
            window.location.href = "./buzos.html";  /*Error en el archivo a mostrar*/
